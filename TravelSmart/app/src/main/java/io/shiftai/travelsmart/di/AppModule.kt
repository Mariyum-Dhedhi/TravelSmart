package io.shiftai.travelsmart.di
...
import io.shiftai.travelsmart.firebase.FirebaseCommon
import io.shiftai.travelsmart.util.Constants.INTRODUCTION_SP
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun provideFilterType(): FilterType {
